...
class StarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create star" do
    assert_difference('Star.count') do
      post stars_url, params: { star: { description: @star.description, name_star: @star.name_star } }
    end
  ...
  test "should update star" do
    patch star_url(@star), params: { star: { description: @star.description, name_star: @star.name_star } }
